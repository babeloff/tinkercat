= TinkerCat Kotlin Multiplatform - Source Material Provenance
:toc: left
:toclevels: 3
:sectnums:
...
This page records the source materials, references, and prior art that shaped TinkerCat' design.
Understanding where ideas came from helps explain *why* the implementation is structured the way it is and gives credit to the original authors.
If you want to understand a specific design decision in depth see the other xref:.[Explanation pages].
...
* *Specific Path*: https://github.com/apache/tinkerpop/tree/master/tinkergraph-gremlin/src/main/java/org/apache/tinkerpop/gremlin/tinkergraph
* *Reference Documentation*: https://tinkerpop.apache.org/docs/current/reference/#tinkergraph-gremlin
* *License*: Apache License 2.0
* *Version Referenced*: 3.8.x branch (master branch)
* *Authors*: Apache TinkerPop Community
* *Description*: The canonical Java in-memory graph implementation, and the reference for TinkerCat's API compatibility and behavior.

**Key Components Referenced:**

* `structure/TinkerGraph.java` - Main graph implementation
* `structure/TinkerVertex.java` - Vertex implementation
* `structure/TinkerEdge.java` - Edge implementation
* `structure/TinkerElement.java` - Base element class
* `structure/TinkerVertexProperty.java` - Vertex property implementation
* `structure/TinkerIndex.java` - Indexing system
* `structure/TinkerHelper.java` - Utility methods
* `structure/TinkerGraphVariables.java` - Graph variables implementation
...
=== TinkerCat JavaScript Implementation

**Secondary Reference for JavaScript Patterns**

* *Repository*: https://github.com/jbmusso/tinkercat-js
...
=== Gremlin TinkerCat JavaScript

**Higher-Level API Reference**

* *Repository*: https://github.com/jbmusso/gremlin-tinkercat
...
* *Path*: https://github.com/apache/tinkerpop/tree/master/tinkergraph-gremlin/src/test/java/org/apache/tinkerpop/gremlin/tinkergraph
...
* *Sources*: JavaScript implementations (tinkercat-js, gremlin-tinkercat)
