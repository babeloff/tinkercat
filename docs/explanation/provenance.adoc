...
=== Apache TinkerPop TinkerCat (Java)

**Primary Reference Implementation**

* *Repository*: https://github.com/apache/tinkerpop
* *Specific Path*: `/tinkercat-gremlin/src/main/java/org/apache/tinkerpop/gremlin/tinkercat/`
* *Reference Documentation*: https://tinkerpop.apache.org/docs/current/reference/#tinkercat-gremlin
* *License*: Apache License 2.0
* *Version Referenced*: 3.7.x branch
* *Authors*: Apache TinkerPop Community
* *Description*: The canonical Java implementation of TinkerCat, serving as the reference for API compatibility and behavior.

**Key Components Referenced:**

* `TinkerCat.java` - Main graph implementation
...
* `TinkerCatVariables.java` - Graph variables implementation
...
* *TinkerCat Specific*: https://tinkerpop.apache.org/docs/current/reference/#tinkercat-gremlin
...
* *Path*: `/tinkercat-gremlin/src/test/java/`
...
----
/*
 * Based on Apache TinkerPop TinkerCat implementation
...
2. **Behavioral compatibility** with Java TinkerCat implementation
