= Migration Guide: From Java TinkerGraph to TinkerCat
:toc: left
:toclevels: 3
:sectnums:
:icons: font
...
This guide shows you how to migrate an existing project from the Java https://github.com/apache/tinkerpop/tree/master/tinkergraph-gremlin/src/main/java/org/apache/tinkerpop/gremlin/tinkergraph[TinkerGraph implementation] to TinkerCat.
...
|===
|Aspect |Java TinkerGraph |TinkerCat
...
[source,java]
----
// OLD Java configuration (TinkerGraph)
...
|===
|Operation |Java TinkerGraph |TinkerCat |Improvement
...
object MigrationUtils {
    fun validateMigration(originalGraph: TinkerGraph, newGraph: TinkerCat): ValidationResult {
        // Compare graph structure and data
    }

    fun exportJavaGraph(graph: TinkerGraph): GraphData {
...
Migrating from Java TinkerGraph to TinkerCat provides significant benefits:
