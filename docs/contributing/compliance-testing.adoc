...
This guide shows you how to implement new TinkerPop compliance tests in TinkerCat, including the mandatory provenance-tracking steps required for Apache License 2.0 compliance.
Follow the workflow in order when adding coverage for a new upstream test.
...
TinkerCat compliance tests are derived from and inspired by the Apache TinkerPop test suite:
...
|*Test Source Path*
|`tinkercat-gremlin/src/test/java`
...
All compliance tests in TinkerCat maintain the same Apache License 2.0 licensing as the original work.

=== Legal Requirements

Every TinkerCat compliance test must:
...
Version: 3.7.2
Path: tinkercat-gremlin/src/test/java/[package]/[TestClass].java
----
...
TinkerPopProvenanceRegistry.registerMapping(TinkerPopTestMapping(
    ...
    adaptations = listOf(
        ...
        "Simplified transaction tests (TinkerCat doesn't support transactions)"
    ),
...
* *URL*: https://github.com/apache/tinkerpop/blob/3.7.2/tinkercat-gremlin/src/test/java/org/apache/tinkerpop/gremlin/structure/GraphTest.java
...
* *URL*: https://github.com/apache/tinkerpop/blob/3.7.2/tinkercat-gremlin/src/test/java/org/apache/tinkerpop/gremlin/structure/VertexTest.java
...
* *URL*: https://github.com/apache/tinkerpop/blob/3.7.2/tinkercat-gremlin/src/test/java/org/apache/tinkerpop/gremlin/structure/EdgeTest.java
* *Kotlin Implementation*: `StructureComplianceTests`, `BasicStructureComplianceTests`
* *Key Methods Ported*:
** `testEdgeEquality()`
** `testEdgeRemoval()`
...
* *URL*: https://github.com/apache/tinkerpop/blob/3.7.2/tinkercat-gremlin/src/test/java/org/apache/tinkerpop/gremlin/structure/FeatureTest.java
...
[source]
----
src/commonTest/kotlin/org/apache/tinkerpop/gremlin/tinkercat/
├── compliance/
...
* *Transaction Interface*: Graceful handling (TinkerCat doesn't support transactions)
...
This comprehensive guide ensures that TinkerCat compliance tests maintain the highest standards of:
...
The comprehensive provenance framework implemented here demonstrates TinkerCat' commitment to open source best practices
