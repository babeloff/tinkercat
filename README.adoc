...
TinkerCat Kotlin Multiplatform is a complete reimplementation of Apache TinkerPop's TinkerCat in-memory graph database using Kotlin Multiplatform. This implementation provides native support for JVM, JavaScript (Node.js/Browser), and Native platforms while maintaining full API compatibility with the original Java implementation.
