"""
Custom exceptions for TinkerCat Python bindings.

This module defines exception classes used throughout the TinkerCat Python
bindings to provide meaningful error messages and proper error handling.
"""


class TinkerCatError(Exception):
    """
    Base exception class for all TinkerCat-related errors.

    This is the base class for all exceptions raised by the TinkerCat
    Python bindings. It provides a common interface for error handling
    and allows users to catch all TinkerCat-related exceptions with
    a single except clause.
    """

    def __init__(self, message: str, cause: Exception = None):
        """
        Initialize a TinkerCatError.
...
class TinkerCatNativeError(TinkerCatError):
    """
    Exception raised when the native TinkerCat library encounters an error.

    This exception is raised when operations on the native Kotlin/Native
    TinkerCat library fail, such as when creating a graph, adding vertices
    or edges, or performing queries.
    """
    pass


class TinkerCatLibraryError(TinkerCatError):
    """
    ...
    cannot locate or load the native TinkerCat shared library.
    """
    pass


class TinkerCatVertexError(TinkerCatError):
    """
...
class TinkerCatEdgeError(TinkerCatError):
    """
...
class TinkerCatMemoryError(TinkerCatError):
    """
...
class TinkerCatValidationError(TinkerCatError):
    """
...
class TinkerCatConfigurationError(TinkerCatError):
    """
