package org.apache.tinkerpop.gremlin.tinkercat.algorithms
 ...
 */
private fun generateRandomGraph(numVertices: Int, edgeProbability: Double): TinkerCat {
 ...
 */
private fun createLinearGraph(numVertices: Int): TinkerCat {
    val graph = TinkerCat.open()
    val vertices = (1..numVertices).map { graph.addVertex("id", it) }
