 ...
 *
 * Based on: https://github.com/apache/tinkerpop/tree/master/tinkercat-gremlin/src/test
 */
...
class TinkerPopComplianceRunner {
    ...
    fun runAllComplianceTests(graph: TinkerCat): ComplianceTestResult {
...
class StructureComplianceRunner {
    ...
    fun runTests(graph: TinkerCat): TestSuiteResult {
...
class FeatureComplianceRunner {
    ...
    private fun testGraphFeatureCompliance(graph: TinkerCat): TestResult {
    ...
    private fun testVertexFeatureCompliance(graph: TinkerCat): TestResult {
    ...
    private fun testEdgeFeatureCompliance(graph: TinkerCat): TestResult {
    ...
    private fun testVertexPropertyFeatureCompliance(graph: TinkerCat): TestResult {
