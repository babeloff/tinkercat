 ...
 *
 * This test suite validates that TinkerCat implements the core TinkerPop Graph structure API
...
class StructureComplianceTests : StringSpec({
    ...
    "Graph features should advertise correct capabilities" {
        ...
        // TinkerCat is an in-memory graph
    ...
    "Vertex features should advertise correct capabilities" {
        ...
        // TinkerCat supports comprehensive vertex features
    ...
    "Edge features should advertise correct capabilities" {
        ...
        // TinkerCat supports comprehensive edge features
    ...
    "Graph should handle transaction operations gracefully" {
        // TinkerCat doesn't support transactions, but should handle gracefully
