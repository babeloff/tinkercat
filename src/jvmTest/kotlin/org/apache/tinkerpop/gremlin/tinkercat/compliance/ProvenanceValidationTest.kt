 ...
 *
 * PROVENANCE:
 * - Original concept: Custom implementation for TinkerCat project
...
class ProvenanceValidationTest : StringSpec({
    ...
    "Base TinkerPop information should be complete" {
        ...
        baseInfo.testSourcePath shouldBe "tinkercat-gremlin/src/test/java"
    ...
    "Java source URLs should be correctly formatted for TinkerPop 3.7.2" {
        ...
        mappings.values.forEach { mapping ->
            ...
            url.contains("tinkercat-gremlin/src/test/java/") shouldBe true
        }
    }
