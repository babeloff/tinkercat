...
/**
 * JVM-specific test suite for TinkerCat platform optimizations.
 *
 ...
 * the common TinkerCat API while providing enhanced functionality available
 * only on the JVM platform.
 *
 * @see org.apache.tinkerpop.gremlin.tinkercat.structure.ConcurrentGraphOperations
 * @see org.apache.tinkerpop.gremlin.tinkercat.structure.JavaCollectionsSupport
 * @see org.apache.tinkerpop.gremlin.tinkercat.structure.JvmSerialization
 * @see org.apache.tinkerpop.gremlin.tinkercat.structure.MemoryMappedStorage
 */
class JvmOptimizationsTest :
        StringSpec({
            ...
            "Java Collections interoperability should work seamlessly" {
                // Create vertices using standard TinkerCat API
            ...
            "ClassLoader compatibility should work correctly" {
                // Test that TinkerCat works with different class loaders
