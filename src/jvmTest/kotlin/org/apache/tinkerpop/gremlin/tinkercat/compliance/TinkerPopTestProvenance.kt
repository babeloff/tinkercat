 ...
 *
 * This framework maintains traceability between TinkerCat Kotlin compliance tests
 ...
 * @see <a href="https://github.com/apache/tinkerpop/tree/master/tinkercat-gremlin/src/test">Original Test Sources</a>
 */
...
object TinkerPopProvenanceRegistry {
    ...
    val BASE_TINKERPOP_INFO = TinkerPopBaseInfo(
        ...
        testSourcePath = "tinkercat-gremlin/src/test/java",
    ...
    init {
        ...
        registerMapping(TinkerPopTestMapping(
            ...
            adaptations = listOf(
                ...
                "Adapted to Kotest StringSpec format",
                "Focused on core Gremlin steps supported by TinkerCat",
...
data class TinkerPopTestMapping(
    ...
    companion object {
        private fun generateSourceUrl(packageName: String, className: String): String {
            ...
            return "https://github.com/apache/tinkerpop/blob/3.7.2/tinkercat-gremlin/src/test/java/$pathifiedPackage/${simpleClassName}.java"
        }
    }
}
