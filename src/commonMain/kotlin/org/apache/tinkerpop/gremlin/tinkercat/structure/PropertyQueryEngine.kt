...
import org.apache.tinkerpop.gremlin.tinkercat.util.CommonCastingUtils
import org.apache.tinkerpop.gremlin.tinkercat.util.LoggingConfig

/**
 * PropertyQueryEngine provides sophisticated property-based query capabilities for TinkerCat.
 *
 ...
 * ```
 *
 * @param graph The TinkerCat instance to execute queries against
 * @see PropertyManager for property lifecycle management
 * @see TinkerCat for graph operations and indexing
 * @see IndexOptimizer for query optimization details
 * @since 1.0.0
 */
class PropertyQueryEngine(private val graph: TinkerCat) {
