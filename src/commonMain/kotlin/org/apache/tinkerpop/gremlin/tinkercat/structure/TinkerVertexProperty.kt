...
/**
 * TinkerVertexProperty is the vertex property implementation for TinkerCat.
 ...
 * - Integration with TinkerCat's indexing and caching systems
...
class TinkerVertexProperty<V>(
...
) : VertexProperty<V>, TinkerElement(id, VertexProperty::class.simpleName ?: "vertexproperty", SafeCasting.asTinkerCat(vertex.graph()) ?: throw IllegalStateException("Expected TinkerCat")) {
     ...
     * In TinkerCat, each meta-property key has at most one value.
     * @param U the expected type of the meta-property values
     * @param key the meta-property key
     ...
     * For TinkerCat, cardinality is determined by the graph's default setting
    ...
    companion object {
        ...
        fun <V> of(vertex: TinkerVertex, key: String, value: V): TinkerVertexProperty<V> {
            val graph = SafeCasting.asTinkerCat(vertex.graph()) ?: throw IllegalStateException("Expected TinkerCat")
