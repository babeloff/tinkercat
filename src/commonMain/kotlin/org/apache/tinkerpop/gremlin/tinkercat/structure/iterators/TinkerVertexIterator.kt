...
/**
 * A memory-efficient iterator for TinkerCat vertices that supports lazy evaluation
...
class TinkerVertexIterator(
    ...
    companion object {
         ...
         */
        fun all(graph: TinkerCat): TinkerVertexIterator {
         ...
         */
        fun byIds(graph: TinkerCat, vararg vertexIds: Any?): TinkerVertexIterator {
         ...
         */
        fun byLabels(graph: TinkerCat, vararg labels: String): TinkerVertexIterator {
