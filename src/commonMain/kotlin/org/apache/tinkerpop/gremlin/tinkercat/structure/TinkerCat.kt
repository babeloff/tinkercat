 ...
 * @since 1.0.0
 */
class TinkerCat private constructor(private val configuration: Map<String, Any?>) : Graph {
    ...
    private val graphVariables: TinkerCatVariables = TinkerCatVariables()
    ...
    internal val allowNullPropertyValues: Boolean =
            configuration[GREMLIN_TINKERCAT_ALLOW_NULL_PROPERTY_VALUES] as? Boolean ?: false
    ...
    internal val defaultVertexPropertyCardinality: VertexProperty.Cardinality =
            VertexProperty.Cardinality.valueOf(
                    configuration[GREMLIN_TINKERCAT_DEFAULT_VERTEX_PROPERTY_CARDINALITY] as?
                            String
                            ?: VertexProperty.Cardinality.SINGLE.name
            )

    /** Graph features describing capabilities. */
    private val graphFeatures: TinkerCatFeatures = TinkerCatFeatures()
    ...
    companion object {
        /** Logger instance for TinkerCat operations. */
        private val logger = Logger.withTag("TinkerCat")

        // Configuration keys
        const val GREMLIN_TINKERCAT_ALLOW_NULL_PROPERTY_VALUES =
                "gremlin.tinkerGraph.allowNullPropertyValues"
        const val GREMLIN_TINKERCAT_DEFAULT_VERTEX_PROPERTY_CARDINALITY =
    ...
    private class TinkerCatFeatures : Graph.Features {
    ...
    private class TinkerCatGraphFeatures : Graph.Features.GraphFeatures {
    ...
    private class TinkerCatVertexFeatures : Graph.Features.VertexFeatures {
    ...
    private class TinkerCatEdgeFeatures : Graph.Features.EdgeFeatures {
        override fun supportsUserSuppliedIds(): Boolean = true
        override fun supportsNumericIds(): Boolean = true
        override fun supportsStringIds(): Boolean = true
        override fun supportsUuidIds(): Boolean = true
