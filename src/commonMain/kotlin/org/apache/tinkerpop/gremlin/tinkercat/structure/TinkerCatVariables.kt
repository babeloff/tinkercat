...
/**
 * TinkerCatVariables provides a key-value store for graph-level metadata.
...
class TinkerCatVariables : Graph.Variables {
    ...
    companion object {
        private val logger = LoggingConfig.getLogger<TinkerCatVariables>()
    }
     ...
     *
     * @return a new TinkerCatVariables instance with the same data
     */
    fun copy(): TinkerCatVariables {
        val copy = TinkerCatVariables()
    ...
    private fun validateValue(value: Any?) {
        // TinkerCat allows any serializable value
    ...
    override fun toString(): String {
        return "TinkerCatVariables[size=${variables.size}]"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is TinkerCatVariables) return false
