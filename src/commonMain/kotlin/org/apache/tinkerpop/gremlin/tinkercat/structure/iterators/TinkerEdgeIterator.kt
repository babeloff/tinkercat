package org.apache.tinkerpop.gremlin.tinkercat.structure.iterators
...
/**
 * A memory-efficient iterator for TinkerCat edges that supports lazy evaluation,
 ...
 *
 * @param graph the TinkerCat instance
...
class TinkerEdgeIterator(
    ...
    companion object {
         ...
         */
        fun all(graph: TinkerCat): TinkerEdgeIterator {
         ...
         */
        fun byIds(graph: TinkerCat, vararg edgeIds: Any?): TinkerEdgeIterator {
         ...
         */
        fun byLabels(graph: TinkerCat, vararg labels: String): TinkerEdgeIterator {
        ...
        fun fromVertex(
            ...
            return TinkerEdgeIterator(
                graph = SafeCasting.asTinkerCat(vertex.graph()) ?: throw IllegalStateException("Expected TinkerCat"),
                direction = direction,
