...
/**
 * GraphSON v3.0 writer implementation for serializing TinkerCat structures.
 *
...
class GraphSONWriter {
    ...
    /**
     * Serializes a TinkerCat to a GraphSON v3.0 JSON string.
     */
    ...
    private fun writeVertices(graph: TinkerCat): JsonArray {
    ...
    private fun writeEdges(graph: TinkerCat): JsonArray {
        return buildJsonArray {
