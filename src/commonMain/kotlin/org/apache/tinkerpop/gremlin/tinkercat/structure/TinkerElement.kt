...
/**
 * Base class for TinkerCat elements (vertices and edges).
 ...
 * - Integration with TinkerCat's indexing system
 ...
 * @param elementGraph the TinkerCat instance that owns this element
 * @since 1.0.0
 */
abstract class TinkerElement(
    protected val elementId: Any,
    protected val elementLabel: String,
    protected val elementGraph: TinkerCat
) : Element {
     ...
     * @return the parent TinkerCat instance
     */
     ...
     * This method is used by the TinkerCat iterators for efficient property access
    ...
    /**
     * TinkerCat-specific property implementation.
     *
     ...
     * with TinkerCat's property management system.
     *
     * @param V the type of the property value
