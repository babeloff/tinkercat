package org.apache.tinkerpop.gremlin.tinkercat.util

import co.touchlab.kermit.Logger
import kotlinx.datetime.Clock

/**
 * Logging configuration and utility class for TinkerCat operations.
 *
 * This class provides centralized logging configuration and utilities for the TinkerCat
 ...
 * ```
 *
 * @author TinkerCat Team
 * @since 3.0.1
 * @see Logger
 */
object LoggingConfig {

    /** Default logger instance for general TinkerCat operations. */
    private val defaultLogger: Logger = Logger.withTag("TinkerCat")

    /** Logger for performance monitoring and metrics. */
    private val performanceLogger: Logger = Logger.withTag("TinkerCat.Performance")

    /** Logger for debug operations and detailed tracing. */
    private val debugLogger: Logger = Logger.withTag("TinkerCat.Debug")
