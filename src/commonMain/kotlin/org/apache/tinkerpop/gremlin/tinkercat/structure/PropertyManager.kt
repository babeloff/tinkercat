...
/**
 * PropertyManager handles advanced property operations for TinkerCat.
 *
 ...
 * ```
 *
 * @param graph The TinkerCat instance to manage properties for
 ...
 */
class PropertyManager(private val graph: TinkerCat) {
