...
import org.apache.tinkerpop.gremlin.tinkercat.memory.NativeMemoryManager
import org.apache.tinkerpop.gremlin.tinkercat.optimization.*
...
class NativePlatformTest : StringSpec({
    ...
    "cross-platform compatibility should work with TinkerCat" {
        shouldNotThrowAny {
            // Test TinkerCat creation with native platform
