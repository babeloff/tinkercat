...
@CucumberOptions(
        ...
        objectFactory = TinkerCatParameterizedFeatureTest.TinkerCatGuiceFactory.class,
        features = { "classpath:/org/apache/tinkerpop/gremlin/test/features" },
        plugin = {"progress", "junit:target/cucumber.xml"})
public class TinkerCatParameterizedFeatureTest {
    ...
    public static final class ServiceModule extends AbstractModule {
        ...
        protected void configure() {
            bind(World.class).to(TinkerWorld.TinkerCatParameterizedWorld.class);
        }
    }
}
