...
import static org.apache.tinkerpop.gremlin.tinkercat.structure.TinkerShuffleGraph.shuffleIterator;

/**
 * @author Cole Greer (https://github.com/Cole-Greer)
 */
public final class TinkerShuffleVertex extends TinkerVertex {
    protected TinkerShuffleVertex(final Object id, final String label, final AbstractTinkerCat graph) {
        super(id, label, graph);
    }

    protected TinkerShuffleVertex(final Object id, final String label, final AbstractTinkerCat graph, final long currentVersion) {
