...
/**
 * Compliance tests for TinkerCat I/O data generation functionality.
 *
 * This test class validates TinkerCat I/O data generation compliance following
...
public class IoDataGenerationTest {
    ...
    private MockTinkerCat graph;
    private Path tempDir;

    @BeforeEach
    public void setUp() throws IOException {
        System.out.println("🧪 Initializing TinkerCat I/O Data Generation Test Suite...");
        graph = createModernGraph();
        tempDir = Files.createTempDirectory("tinkercat-io-test");
    }
    ...
    public void tearDown() throws IOException {
        ...
        System.out.println("🧹 TinkerCat I/O Data Generation Test Suite - Cleaned up");
    }
    ...
    public void shouldDeserializeGraphFromGraphSON() throws IOException {
        ...
        MockTinkerCat deserializedGraph = MockTinkerCat.open();
    ...
    public void shouldHandleIOWithVertexProperties() throws IOException {
        ...
        MockTinkerCat complexGraph = MockTinkerCat.open();
    ...
    public void shouldHandleIOWithEdgeProperties() throws IOException {
        ...
        MockTinkerCat edgeGraph = MockTinkerCat.open();
    ...
    public void shouldHandleLargeGraphIOOperations() throws IOException {
        ...
        // Create larger graph
        MockTinkerCat largeGraph = createLargeGraph(100);
    ...
    public void shouldHandleIOErrorConditionsGracefully() {
        ...
        assertThrows(IOException.class, () -> {
            ...
            MockTinkerCat testGraph = MockTinkerCat.open();
    ...
    private void serializeToGraphSON(MockTinkerCat graph, OutputStream out) throws IOException {
    ...
    private void deserializeFromGraphSON(MockTinkerCat graph, InputStream in) throws IOException {
    ...
    private void serializeToGryo(MockTinkerCat graph, OutputStream out) throws IOException {
    ...
    private void deserializeFromGryo(MockTinkerCat graph, InputStream in) throws IOException {
    ...
    private MockTinkerCat createModernGraph() {
        MockTinkerCat modernGraph = MockTinkerCat.open();
    ...
    private MockTinkerCat createLargeGraph(int vertexCount) {
        MockTinkerCat largeGraph = MockTinkerCat.open();
