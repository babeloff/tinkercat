...
/**
 * Compliance tests for TinkerCat ID management functionality.
 *
 * This test class validates TinkerCat ID management compliance following
...
public class IdManagerTest {
    ...
    public void shouldGenerateNiceErrorOnConversionOfStringToInt() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            // Simulate TinkerCat.DefaultIdManager.INTEGER.convert("string-id")
    ...
    public void shouldGenerateNiceErrorOnConversionOfJunkToInt() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            // Simulate TinkerCat.DefaultIdManager.INTEGER.convert(UUID.randomUUID())
    ...
    public void shouldGenerateNiceErrorOnConversionOfStringToLong() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            // Simulate TinkerCat.DefaultIdManager.LONG.convert("string-id")
    ...
    public void shouldGenerateNiceErrorOnConversionOfJunkToLong() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            // Simulate TinkerCat.DefaultIdManager.LONG.convert(UUID.randomUUID())
    ...
    public void shouldGenerateNiceErrorOnConversionOfStringToUUID() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            // Simulate TinkerCat.DefaultIdManager.UUID.convert("invalid-uuid-string")
    ...
    // Mock ID conversion methods to simulate TinkerCat.DefaultIdManager behavior
