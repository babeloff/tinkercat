...
public class TinkerCatIdManagerTest {
    ...
    public static class NumberIdManagerTest {
        ...
        public static void setup() {
            longIdManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERCAT_EDGE_ID_MANAGER, TinkerCat.DefaultIdManager.LONG.name());
            longIdManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERCAT_VERTEX_ID_MANAGER, TinkerCat.DefaultIdManager.LONG.name());
            longIdManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERCAT_VERTEX_PROPERTY_ID_MANAGER, TinkerCat.DefaultIdManager.LONG.name());

            integerIdManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERCAT_EDGE_ID_MANAGER, TinkerCat.DefaultIdManager.INTEGER.name());
            integerIdManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERCAT_VERTEX_ID_MANAGER, TinkerCat.DefaultIdManager.INTEGER.name());
            integerIdManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERCAT_VERTEX_PROPERTY_ID_MANAGER, TinkerCat.DefaultIdManager.INTEGER.name());
        }
    ...
    public static class UuidIdManagerTest {
        ...
        @BeforeClass
        public static void setup() {
            idManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERCAT_EDGE_ID_MANAGER, TinkerCat.DefaultIdManager.UUID.name());
            idManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERCAT_VERTEX_ID_MANAGER, TinkerCat.DefaultIdManager.UUID.name());
            idManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERCAT_VERTEX_PROPERTY_ID_MANAGER, TinkerCat.DefaultIdManager.UUID.name());
        }
