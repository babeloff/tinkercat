 ...
 */
public class TinkerShuffleGraph extends TinkerCat {
    ...
    @Override
    protected TinkerVertex createTinkerVertex(final Object id, final String label, final AbstractTinkerCat graph) {
        return new TinkerShuffleVertex(id, label, graph);
    }

    protected TinkerVertex createTinkerVertex(final Object id, final String label, final AbstractTinkerCat graph, final long currentVersion) {
