...
/** Tests for TinkerCatJSAdapter functionality in JavaScript environments. */
class TinkerCatJSAdapterTest : StringSpec({

    lateinit var adapter: TinkerCatJSAdapter

    beforeTest {
        adapter = TinkerCatJSAdapter.open()
    }
