...
/**
 * JVM-specific utilities for Java Collections interoperability with TinkerCat.
 * Provides seamless integration between TinkerCat elements and standard Java Collections.
 */
object JavaCollectionsSupport {

    /**
     * Converts a TinkerCat vertex iterator to a Java Stream.
     */
    ...
    /**
     * Converts a TinkerCat edge iterator to a Java Stream.
     */
    ...
    /**
     * Converts TinkerCat vertices to a Java List.
     */
    ...
    /**
     * Converts TinkerCat edges to a Java List.
     */
    ...
    /**
     * Converts TinkerCat vertices to a Java Set.
     */
    ...
    /**
     * Converts TinkerCat edges to a Java Set.
     */
    ...
    /**
     * Thread-safe wrapper for TinkerCat operations.
     */
    class ThreadSafeGraphWrapper(private val graph: TinkerCat) {
        private val readWriteLock = java.util.concurrent.locks.ReentrantReadWriteLock()
        private val readLock = readWriteLock.readLock()
        private val writeLock = readWriteLock.writeLock()

        fun <T> read(operation: (TinkerCat) -> T): T {
            readLock.lock()
            try {
        ...
        fun <T> write(operation: (TinkerCat) -> T): T {
            writeLock.lock()
            try {
                return operation(graph)
            } finally {
    ...
    /**
     * Creates a Java Optional from a nullable TinkerCat element.
     */
    ...
    /**
     * Converts TinkerCat property iterator to Java Stream.
     */
