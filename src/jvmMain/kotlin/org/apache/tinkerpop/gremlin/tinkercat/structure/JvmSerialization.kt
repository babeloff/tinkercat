...
/**
 * JVM-specific serialization support for TinkerCat using Java Serializable.
 * Provides efficient serialization and deserialization of graph elements and entire graphs.
 */
object JvmSerialization {

    /**
     * Serializable wrapper for TinkerCat data.
     */
    ...
    /**
     * Serialize a TinkerCat to a byte array.
     */
    fun serializeGraph(graph: TinkerCat): ByteArray {
    ...
    /**
     * Serialize a TinkerCat to a file.
     */
    fun serializeGraphToFile(graph: TinkerCat, filePath: String, compressed: Boolean = true) {
    ...
    /**
     * Deserialize a TinkerCat from a byte array.
     */
    fun deserializeGraph(data: ByteArray): TinkerCat {
    ...
    /**
     * Deserialize a TinkerCat from a file.
     */
    fun deserializeGraphFromFile(filePath: String, compressed: Boolean = true): TinkerCat {
        val path = Paths.get(filePath)
     ...
     */
    fun deserializeVertex(data: ByteArray, graph: TinkerCat): Vertex {
     ...
     */
    fun deserializeEdge(data: ByteArray, graph: TinkerCat): Edge {
     ...
     */
    fun getSerializationStats(graph: TinkerCat): Map<String, Any> {
    ...
    /**
     * Convert TinkerCat to serializable representation.
     */
    private fun convertToSerializable(graph: TinkerCat): SerializableGraph {
    ...
    /**
     * Convert serializable representation to TinkerCat.
     */
    private fun convertFromSerializable(serializableGraph: SerializableGraph): TinkerCat {
    ...
    /**
     * Convert serializable vertex back to TinkerCat vertex.
     */
    ...
    /**
     * Convert serializable edge back to TinkerCat edge.
     */
     ...
     */
    private fun estimateGraphSize(graph: TinkerCat): Long {
